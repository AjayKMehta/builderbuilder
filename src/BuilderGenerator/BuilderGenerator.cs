...
public class BuilderGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        IncrementalValuesProvider<(ClassToGenerate? Left, Compilation Right)> compilationAndClasses = classesToGenerate.Combine(context.CompilationProvider);

        context.RegisterImplementationSourceOutput(compilationAndClasses,
...
#pragma warning disable CA1031 // Do not catch general exception types
        try
        {
            ...
            {
                CSharpCompilation csComp =>
                $"""
                // Generated by BuilderGenerator
                // Assembly: {compilation.AssemblyName}
                // Language version: {csComp.LanguageVersion}
                // Source type: {value.FullTypeName}
                """,
                _ => string.Empty,
            };
            var source = compilationInfo + TypeBuilderWriter.Write(value);
